window.calcRT = ev => {
    const content = document.querySelector('main'); // grabs all the content in the <main> element
    const numWords = content.innerText.split(' ').length; //counts number of words in the content
